"use strict";
let inventory = [
    { id: "P1001", name: "iPhone 15", category: "electronic products", quantity: 25, price: 6999, supplier: "Apple Inc.", stockStatus: "in stock", hotItem: "Yes", comments: "Hot selling flagship" },
    { id: "P1002", name: "Office Chair", category: "furniture", quantity: 3, price: 899, supplier: "IKEA", stockStatus: "Low inventory", hotItem: "No", comments: "Ergonomic" }
];
let editMode = false;
let editingId = null;
...
const hotItemSelect = document.getElementById('hotItem');
...
const showHotBtn = document.getElementById('showHotBtn');
...
function isIdUnique(id, excludeId) {
...
function saveProduct(event) {
    ...
    const hotItem = hotItemSelect.value;
    ...
    const newItem = { id, name, category, quantity, price, supplier, stockStatus, hotItem, comments };
